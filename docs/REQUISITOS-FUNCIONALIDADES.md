...
| Audio ambiente | `index.html`, `audio-player.js` | Toca trilha medieval opcional com player customizado. | Usar `<audio>` com fontes MP3/OGG, Play/Pause, volume, persistencia e erro compreensivel. | Alternar botao, mudar volume, recarregar e confirmar estado inicial. |
